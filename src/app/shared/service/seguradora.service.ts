...
export class SeguradoraService{
  ...
  atualizar(idSeguradora: number, seguradora: Seguradora): Observable<Seguradora>{
    return this.httpClient.put<Seguradora>(this.API, seguradora +'/atualizar/'+idSeguradora);
  }
